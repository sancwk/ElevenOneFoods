...
<div class="container">
    <div class="col-lg-12" >
        ...
        <div class="col-lg-6">
            <div class="row">
                <form role="form" action="php/insertdb.php" method="post" autocomplete="off">
                    <div class="col-lg-12">
                        ...
                        <input type="submit" name="submit" id="submit" value="Register" onClick="return ConfirmVal();" class="btn btn-info pull-right">
                    </div>
                </form>
