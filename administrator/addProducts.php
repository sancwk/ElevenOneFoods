...
<head>
    <meta charset="utf-8"/>
    <title>ElevenOne Foods - Add products</title>
...
<div id="userPanel" style="position:absolute; background:rgba(200,200,200, 0.8); padding:10px; border-radius=5px; margin-left: 400px;">
    ...
    <h1 style="background: rgba(200,200,200, 0.6); margin: 0 auto; width: auto;"><small>Add Products</small> <a class="navbar-brand" href="#">ElevenOne Foods</a></h1>
</div>
<div class="container">
    <div class="row">
        <form role="form" method="POST" action="pController.php?flag=add">
        ...
        <div class="col-lg-5 col-md-push-1">
            <div class="col-md-12">                
                ...
                <center>
                    <strong><span class="glyphicon glyphicon-ok"></span> Product added to the system successfully.</strong>
                </center>
                </div>
